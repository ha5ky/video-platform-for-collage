...
<div class="right" id="right" name="right">
    ...
    <div class="rightinfo">    
	    <div class="tools">	    
	    	<ul class="toolbar">
	        <li><a href="<?php echo U('/admin/system/insert_t');?>"><span><img src="/Admin/images/t01.png" /></span>添加</a></li>
	        </ul>
	    ...
	    <table class="tablelist">
	        ...
	        <tbody>
	        	<?php if(is_array($conf)): $i = 0; $__LIST__ = $conf;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>                                    
	        			...
	        			<td><?php echo ($vo["t_role"]); ?></td>
	        			<td><a href="<?php echo U('/admin/system/delete_t', array('num' => $vo['t_num']));?>" class="tablelink">删除</a>     <a href="<?php echo U('/admin/system/details_t',array('tid' => $vo['tid']));?>" class="tablelink" >修改</a></td>
