  ...
  <div class="right" id="right" name="right">
    <div class="place">
      ...
      <ul class="placeul">
        ...
        <li><a href="<?php echo U('/admin/System/top_video');?>">视频置顶</a></li>
      </ul>
    </div>
    ...
    <div class="rightinfo">    
      ...
      <form action="<?php echo U('Admin/System/video_operate');?>" method="post">
        ...
        <tbody>
          ...
          <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
            <td><?php echo ($vo["slide_video"]); ?></td>
              <td><?php echo (date("Y-m-d",$vo["slide_time"])); ?></td>
              <td><?php echo ($vo["types"]); ?></td>
              <td>
                <input type="checkbox" name="checkbox" value="<?php echo ($vo["slide_id"]); ?>">
              </td>
                    <!-- <td>
                        <a href="<?php echo U('/admin/admin/update_c',array('sort_id' => $vo['sort_id'],'sort_name' => $vo['sort_name']));?>" class="tablelink" >置于首页</a>
                      </td> -->
              ...
              <br>
              <label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label><input name="" type="submit" class="btn" value="确认保存"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>&nbsp;</label><input id="cancel" name="" type="reset" class="btn" value="取消保存"/>
            </form>
            <div class="tip">
