...
<div class="right" id="right" name="right">
    <div class="place">
    	...
    	<ul class="placeul">
            ...
            <li><a href="<?php echo U('/admin/system/user');?>">管理员设置</a></li>
    		<li><a href="#">修改参数</a></li>
    	</ul>
    </div>
    <div class="formbody">
    <div class="formtitle"><span>基本信息</span></div>
        <form id="form1" action="<?php echo U('/admin/system/update_t');?>" method="post">  <!-- 插入数据到数据库-->
            <ul class="forminfo">
                ...
                <li><label>权限</label><input name="t_role" type="text" class="dfinput"></input></li>
