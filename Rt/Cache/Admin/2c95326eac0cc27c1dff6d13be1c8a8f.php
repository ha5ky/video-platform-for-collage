...
<body style="background:url(/Admin/images/topbg.gif) repeat-x;">
	<div class="top">
    <div class="topleft">
        <a href="/index.php/Admin/Index/main.html" target="_parent"><img src="/Admin/images/logo.png" title="系统首页" /></a>
    </div>
    ...
    <div class="right" id="right" name="right">
        ...
        <div class="mainindex">
            ...
            <div class="welinfo">
                ...
                <b>早上好，欢迎使用信息管理系统，当前登录账号：<?php echo session('user_name'); ?></b>
            </div>

            <div class="welinfo">
                <span><img src="/Admin/images/time.png" alt="时间" /></span>
                <i>您上次登录的时间：<?php echo (date("Y-m-d H:i:s",$time)); ?></i>
            </div>
