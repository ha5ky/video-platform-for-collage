...
<div class="right" id="right" name="right">
    ...
    <div class="rightinfo">    
      <div class="tools">     
        <ul class="toolbar">
          <li><a href="<?php echo U('/admin/admin/insert_s');?>"><span><img src="/Admin/images/t01.png" /></span>添加</a></li>
          </ul>
          <ul class="toolbar1">
          <li><a href="<?php echo U('/admin/upload/plenty');?>"><span><img src="/Admin/images/t05.png" /></span>批量添加</a></li>
          </ul>
      ...
      <tbody>
        <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>                                    
            ...
            <td><?php echo ($vo["std_num"]); ?></td>
            <td><?php echo ($vo["std_name"]); ?></td>
            <td><a href="<?php echo U('/admin/admin/delete_s', array('num' => $vo['std_num']));?>" class="tablelink">删除</a>     <a href="<?php echo U('/admin/admin/details_s',array('sid' => $vo['sid']));?>" class="tablelink" >修改</a></td>
