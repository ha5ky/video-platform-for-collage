	    ...
	    <table class="tablelist">
	        ...
	        <tbody>
	        	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>                                    
	        			...
	        			<td><?php echo ($vo["v_intro"]); ?></td>
	        			<td><?php echo ($vo["v_time"]); ?></td>
	        			<td><?php echo ($vo["v_status"]); ?></td>
	        			<td><?php echo ($vo["count"]); ?></td>
	        			<td>
	        			<!-- <a href="<?php echo U('/admin/teacher/delete_count', array('id' => $vo['vid']));?>" class="tablelink">删除</a>      -->
	        			<!-- <a href="<?php echo U('/admin/teacher/details_count',array('vid' => $vo['vid'],'name' => $vo['v_name'],'intro' => $vo['v_intro'],'time' => $vo['v_time'],'status' => $vo['v_status']));?>" class="tablelink" >查看</a></td> -->
