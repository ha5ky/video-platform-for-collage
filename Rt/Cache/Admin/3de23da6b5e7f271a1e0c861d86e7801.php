...
<div class="right" id="right" name="right">
    ...
    <div class="formtitle"><span>基本信息</span></div>
        <form id="form1" action="<?php echo U('admin/teacher/update_com');?>" method="post">  <!-- 插入数据到数据库-->
            <ul class="forminfo">
                <li><label>ID</label><input name="id" type="text" value="<?php echo ($com_id); ?>" readonly="" class="dfinput" /><i></i></li>
                <li><label>评论</label><input name="c_num" type="text" value="<?php echo ($com_content); ?>" readonly="" class="dfinput" /><i></i></li>
                <li><label>评论时间</label><input name="time" type="text" value="<?php echo (date('Y-m-d,H:i:s',$com_time)); ?>" readonly="" class="dfinput" value="" /></li>
                <li><label>审核状态</label><input name="sta" type="text" value="<?php echo ($com_status); ?>" class="dfinput" value="" /></li>
