      ...
      <table class="tablelist">
        ...
        <tbody>
            <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                    ...
                    <td><a href="<?php echo U('/admin/teacher/delete_m', array('sort_id' => $vo['sort_id']));?>" class="tablelink">删除</a>     <a href="<?php echo U('/admin/teacher/details_m',array('sort_id' => $vo['sort_id'],'sort_name' => $vo['sort_name']));?>" class="tablelink" >查看</a></td>
