...
<div class="right" id="right" name="right">
    ...
    <div class="formtitle"><span>基本信息</span></div>
        <form id="form2" action="<?php echo U('/admin/admin/update_s');?>" method="post">  <!-- 插入数据到数据库-->
            <ul class="forminfo">
                <li><label>sid</label><input name="sid" type="text" value="<?php echo ($sid); ?>" class="dfinput" readonly="" /><i></i></li>
                <li><label>学号</label><input name="std_num" type="text" class="dfinput" /><i></i></li>
                <li><label>姓名</label><input name="std_name" type="text" class="dfinput" value="" /></li>
