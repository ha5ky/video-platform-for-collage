...
<body style="background:url(/Admin/images/topbg.gif) repeat-x;">
	<div class="top">
    <div class="topleft">
        <a href="/index.php/Admin/Other/main.html" target="_parent"><img src="/Admin/images/logo.png" title="系统首页" /></a>
    </div>
...
<div class="right" id="right" name="right">
    ...
    <div class="formtitle"><span>基本信息</span></div>
        <form id="form1" action="<?php echo U('/admin/other/update_p');?>" method="post">  <!-- 插入数据到数据库-->
            <ul class="forminfo">
                <li><label>tid</label><input name="tid" type="text" value="<?php echo ($id); ?>" class="dfinput" readonly="" /><i></i></li>
                <li><label>姓名</label><input name="t_rname" type="text" value="<?php echo ($name); ?>" class="dfinput" readonly="" /><i></i></li>
                <li><label>工号</label><input name="t_num" type="text" class="dfinput" value="<?php echo ($num); ?>" readonly="" /></li>
                <li><label>密码修改</label><input name="t_pwd" type="password" class="dfinput" /></li>
                <li><label>确认密码</label><input name="confirm_pwd" type="password" class="dfinput"  /></li>
