...
<div class="right" id="right" name="right">
    <div class="place">
    	...
    	<ul class="placeul">
            ...
            <li><a href="<?php echo U('/admin/admin/teacher');?>">教师设置</a></li>
    		<li><a href="#">修改参数</a></li>
    	</ul>
    </div>
    <div class="formbody">
    <div class="formtitle"><span>基本信息</span></div>
        <form id="form1" action="<?php echo U('/admin/admin/update_t');?>" method="post">  <!-- 插入数据到数据库-->
            <ul class="forminfo">
                <li><label>tid</label><input name="tid" type="text" value="<?php echo ($tid); ?>" class="dfinput" readonly="" /><i></i></li>
                <li><label>姓名</label><input name="t_rname" type="text" class="dfinput" /><i></i></li>
                <li><label>工号</label><input name="t_num" type="text" class="dfinput" value="" /></li>
                <li><label>密码修改</label><input name="t_pwd" type="password" class="dfinput" value="" /></li>
                <li><label>权限</label><input name="t_role" type="text" value="<?php echo ($role); ?>" class="dfinput" ></input></li>
