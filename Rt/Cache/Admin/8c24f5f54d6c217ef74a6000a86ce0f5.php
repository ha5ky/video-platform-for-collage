...
<div class="right" id="right" name="right">
    <div class="place">
    	...
    	<ul class="placeul">
    		...
    		<li><a href="<?php echo U('/admin/admin/course');?>">课程设置</a></li>
    		<li><a href="#">修改参数</a></li>
    	</ul>
    </div>
    <div class="formbody">
        <div class="formtitle"><span>基本信息</span></div>
        <form id="form1" action="<?php echo U('/admin/admin/update_f');?>" method="post">  <!-- 插入数据到数据库-->
            <ul class="forminfo">
                <li><label>分类ID</label><input name="sort_id" type="text" value="<?php echo ($sort_id); ?>" class="dfinput" readonly="" /><i></i></li>
