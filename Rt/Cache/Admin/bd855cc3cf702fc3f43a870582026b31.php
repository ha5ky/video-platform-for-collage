...
<div class="right" id="right" name="right">
    <div class="place">
    	...
    	<ul class="placeul">
    		...
    		<li><a href="<?php echo U('/admin/admin/count');?>">数据统计</a></li>
    		<li><a href="#">查看参数</a></li>
    	</ul>
    </div>
    ...
    <div class="formtitle"><span>基本信息</span></div>
        <form id="form1" action="<?php echo U('admin/admin/insert_chapter');?>" method="post">  <!-- 插入数据到数据库-->
            <ul class="forminfo">
                <li><label>ID</label><input name="sort_name" type="text" value="<?php echo ($id); ?>" class="dfinput" readonly="" /><i></i></li>
                <li><label>教师姓名</label><input name="c_num" type="text" class="dfinput" value="<?php echo ($name); ?>" readonly="" /><i></i></li>
                <li><label>教师工号</label><input name="c_name" type="text" class="dfinput" value="<?php echo ($num); ?>" /></li>
                <li><label>已上传视频数</label><input name="t_rname" type="text" value="<?php echo ($count); ?>" class="dfinput" readonly="" /></li>
