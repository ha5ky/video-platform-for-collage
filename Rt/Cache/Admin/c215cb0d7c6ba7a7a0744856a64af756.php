...
<div class="right" id="right" name="right">
    ...
    <div class="formtitle"><span>基本信息</span></div>
        <form id="form1" action="<?php echo U('admin/admin/insert_student');?>" method="post">  <!-- 插入数据到数据库-->
            <ul class="forminfo">
                <li><label>tid</label><input name="tid" type="text" placeholder="" class="dfinput"/><i></i></li>
                <li><label>学号</label><input name="num" type="text" class="dfinput" /><i></i></li>
