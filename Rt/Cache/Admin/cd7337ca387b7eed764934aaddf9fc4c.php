...
<div class="right" id="right" name="right">
    ...
    <div class="rightinfo">    
	    <div class="tools">	    
	    	<ul class="toolbar">
	        <li><a href="<?php echo U('/admin/system/config_add');?>"><span><img src="/Admin/images/t01.png" /></span>添加</a></li>
	        </ul>
	        <ul class="toolbar1">
	    ...
	    <table class="tablelist">
	        ...
	        <tbody>
	        	<?php if(is_array($conf)): $i = 0; $__LIST__ = $conf;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				        <td><input name="" type="checkbox" value="" /></td>
				        <td><?php echo ($vo["conf_id"]); ?></td>
				        <td><?php echo ($vo["conf_sort"]); ?></td>
				        <td><?php echo ($vo["conf_name"]); ?></td>
				        <td><?php echo ($vo["conf_value"]); ?></td>
				        <td><?php echo ($vo["conf_pid"]); ?></td>
				        <td><a href="<?php echo U('Admin/System/details_conf',array('id' => $vo['conf_id']));?>" class="tablelink">查看</a>     <a href="<?php echo U('Admin/System/delete_conf',array('id' => $vo['conf_id']));?>" class="click"> 删除</a></td>
