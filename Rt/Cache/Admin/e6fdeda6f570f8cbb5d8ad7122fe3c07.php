...
<div class="right" id="right" name="right">
    ...
    <div class="rightinfo">    
      <div class="tools">     
        <ul class="toolbar">
          <li><a href="<?php echo U('/admin/admin/insert_f');?>"><span><img src="/Admin/images/t01.png" /></span>添加</a></li>
          </ul>
      ...
      <table class="tablelist">
        ...
        <tbody>
            <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                    ...
                    <td><a href="<?php echo U('/admin/admin/delete_f', array('sort_id' => $vo['sort_id']));?>" class="tablelink">删除</a>     <a href="<?php echo U('/admin/admin/details_f',array('sort_id' => $vo['sort_id']));?>" class="tablelink" >修改</a></td>
