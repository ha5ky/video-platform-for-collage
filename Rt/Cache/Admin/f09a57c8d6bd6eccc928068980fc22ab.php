...
<body style="background:url(/Admin/images/topbg.gif) repeat-x;">
	<div class="top">
    <div class="topleft">
        <a href="/index.php/Admin/Upload/main.html" target="_parent"><img src="/Admin/images/logo.png" title="系统首页" /></a>
    </div>
...
<div class="right" id="right" name="right">
    <div class="place">
      ...
      <ul class="placeul">
        ...
        <li><a href="<?php echo U('/admin/admin/student');?>">学生设置</a></li>
        <li><a href="#">修改</a></li>
      </ul>
    </div>
    <div class="formbody">
    <div class="formtitle"><span>基本信息</span></div>
        <form id="form2" enctype="multipart/form-data" action="<?php echo U('/admin/upload/students');?>" method="post">  <!-- 插入数据到数据库-->
            <ul class="forminfo">
                <li><label>文件类型</label><input type="text" class="dfinput" classname="suffix" /></li>
                <li><label>excel选择</label><input type="file" name="excel" /></li>
