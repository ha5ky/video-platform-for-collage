...
<div class="right" id="right" name="right">
    ...
    <div class="formbody">
        ...
        <form id="form1" action="<?php echo U('admin/admin/insert_course');?>" method="post" enctype="multipart/form-data">  <!-- 插入数据到数据库-->
            <ul class="forminfo">
                ...
                <li><label>图片上传</label><input name="img" type="file"  value="" /></li>
