...
<div class="right" id="right" name="right">
    ...
    <div class="formbody">
        <form id="form1" action="<?php echo U('/admin/teacher/update_m');?>" method="post">  <!-- 插入数据到数据库-->
            <ul class="forminfo">
                <li><label>科目</label><input name="" type="text" value="<?php echo ($sort_name); ?>" class="dfinput" readonly="" /><i></i></li>
            </ul>
        </form>
        <div class="tools">     
        <ul class="toolbar">
          <li><a href="<?php echo U('/admin/teacher/insert_m');?>"><span><img src="/Admin/images/t01.png" /></span>添加</a></li>
          </ul>
        ...
        <tbody>
            <?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                    ...
                    <td><?php echo ($vo["sort_pid"]); ?></td>
                    <td>
                        <a href="<?php echo U('/admin/teacher/delete_m', array('sort_id' => $vo['sort_id']));?>" class="tablelink">删除</a>
                        <a href="<?php echo U('/admin/teacher/update_m',array('sort_id' => $vo['sort_id'],'sort_name' => $vo['sort_name']));?>" class="tablelink" >修改</a>
                    </td>
