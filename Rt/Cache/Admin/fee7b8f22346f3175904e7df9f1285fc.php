...
<div class="right" id="right" name="right">
    <div class="place">
    	...
    	<ul class="placeul">
    		...
    		<li><a href="<?php echo U('/admin/teacher/count_t');?>">数据统计</a></li>
    		<li><a href="#">查看参数</a></li>
    	</ul>
    </div>
    ...
    <div class="formtitle"><span>基本信息</span></div>
        <form id="form1" action="<?php echo U('admin/teacher/insert_chapter');?>" method="post">  <!-- 插入数据到数据库-->
            <ul class="forminfo">
                <li><label>ID</label><input name="sort_name" type="text" value="<?php echo ($vid); ?>" class="dfinput" readonly="" /><i></i></li>
                <li><label>视频名称</label><input name="c_num" type="text" class="dfinput" value="<?php echo ($name); ?>" readonly="" /><i></i></li>
                <li><label>视频介绍</label><input name="c_name" type="text" class="dfinput" value="<?php echo ($intro); ?>" /></li>
                <li><label>上传时间</label><input name="c_name" type="text" class="dfinput" value="<?php echo ($time); ?>" /></li>
                <li><label>视频状态</label><input name="c_name" type="text" class="dfinput" value="<?php echo ($status); ?>" /></li>
                <li><label>被观看数</label><input name="t_rname" type="text" value="<?php echo ($count); ?>" class="dfinput" readonly="" /></li>
                <li><label>&nbsp;</label><input name="" type="submit" class="btn" value="确认保存"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label>&nbsp;</label><input id="cancel" name="" type="reset" class="btn" value="取消保存"/></li>
            </ul>
         </form>
