								...
								<div id="myTabContent" class="tab-content">
									<div role="tabpanel" class="tab-pane fade in active" id="home1" aria-labelledby="home1-tab">
										<div class="wthree-news-top-left">
											<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-md-6 w3-agileits-news-left">
												<div class="col-sm-5 wthree-news-img">
													<a href="<?php echo U('Home/Index/single',array('video_id' => $vo['vid']));?>"><img src="/Public/images/m2.jpg" alt="" /></a>
												</div>
												<div class="col-sm-7 wthree-news-info">
													<h5><a href="<?php echo U('Home/Index/single',array('video_id' => $vo['vid']));?>"><?php echo ($vo["v_name"]); ?></a></h5>
													<p><?php echo ($vo["v_intro"]); ?></p>
													<ul>
						...
						<div class="list">
							<ul class="yiji">
								...
								<?php if(is_array($v1)): foreach($v1 as $key=>$it): ?><li><a href="" class="inactive"><?php echo ($it["sort_name"]); ?></a>
									...
									<?php if(is_array($v2)): foreach($v2 as $key=>$it2): if($it2['sort_pid'] == $it['sort_id']): ?><li><a href="<?php echo U('Home/Index/single_list',array('sort_id' => $it2['sort_id']));?>" class="inactive active"><?php echo ($it2["sort_name"]); ?></a>
											<!-- <ul>
												<li><a href="#">二级章节</a></li>
												<li><a href="#">二级章节</a></li>
												<li><a href="#">二级章节</a></li>
