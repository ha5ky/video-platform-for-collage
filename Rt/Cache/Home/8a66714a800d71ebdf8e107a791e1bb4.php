								...
								<div id="myTabContent" class="tab-content">
									<div role="tabpanel" class="tab-pane fade in active" id="home1" aria-labelledby="home1-tab">
										<div class="wthree-news-top-left">
											<?php if(is_array($v1)): foreach($v1 as $key=>$v): ?><div class="col-md-6 w3-agileits-news-left">
													<div class="col-sm-5 wthree-news-img">
														<a href="<?php echo U('Home/Index/sort_list',array('sort_id' => $v['sort_id']));?>"><img src="<?php echo ($v['sort_img']); ?>" alt="" /></a>
													</div>
													<div class="col-sm-7 wthree-news-info">
														<h5><a href="<?php echo U('Home/Index/sort_list',array('sort_id' => $v['sort_id']));?>"><?php echo ($v["sort_name"]); ?></a></h5>
														<p><?php echo ($v["sort_intro"]); ?></p>
														<ul>
